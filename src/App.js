  ...
  const projects = [
    {
      ...
      description:
        "PodCaster AI is a Django-powered web app that lets you generate podcast scripts using AI and convert them into natural-sounding audio with Piper TTS — all offline and fully customizable.",
      tech: [
        "Python",
        "Django",
        "AI",
    ...
    },
    {
      ...
      description:
        "Autonomous robot using NVIDIA Jetson Nano to identify medicinal plants in remote areas with real-time image classification and deep learning techniques.",
    ...
    },
    {
      ...
      description:
        "Advanced voice cloning interface using TortoiseTTS library with machine learning techniques to transform and clone voices with high fidelity.",
    ...
    },
    {
      ...
      description:
        "Intelligent organizational assistant web application with NLP capabilities for information queries and complaint management through conversational AI.",
      tech: [
        "Python",
        "MongoDB",
        "NLP",
    ...
    },
    {
      ...
      description:
        "Machine Learning web application using Streamlit and YOLOv8 for detecting heritage monuments from satellite images with high accuracy.",
      tech: [
        "Python",
        "YOLOv8",
        "Streamlit",
  ...
  const achievements = [
    {
      ...
      icon: Award,
      description:
        "Won first place for innovative MedBot project at international exhibition",
    },
    {
      ...
      icon: Award,
      description:
        "Software Domain winner at Francis Xavier Engineering College hackathon",
    },
    {
      ...
      icon: Award,
      description:
        '"MedBot: An AI-integrated Rover for Medicinal Plant Detection"',
    },
  ];
  ...
  const certifications = [
    {
      ...
      date: "August 2025",
      description:
        "Demonstrated expertise in building generative AI applications using Oracle Cloud Infrastructure",
    },
    {
      ...
      date: "October 2023",
      description:
        "Completed comprehensive NLP course covering tokenization, sentiment analysis, and model building",
    },
    {
      ...
      date: "November 2022",
      description:
        "Hands-on workshop on chatbot architecture, design, and web integration",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          >
            Building intelligent AI solutions, crafting scalable web
            applications, and developing innovative robotics projects with
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                <p>
                  I'm a passionate Computer Science & Business Systems graduate
                  from Francis Xavier Engineering College with a CGPA of 8.6. My
                  expertise lies in developing innovative AI solutions and
                  building robust web applications using Python and modern
                  frameworks.
                </p>
                <p>
                  My journey includes creating autonomous robots for medicinal
                  plant detection, developing voice cloning systems, and
                  building intelligent chatbots. I've successfully led teams in
                  hackathons, published patents, and gained recognition at
                  international exhibitions.
                </p>
                <p>
                  Currently, I'm expanding my full-stack development skills
                  while working on cutting-edge projects that combine AI,
                  computer vision, and web technologies to solve real-world
                  problems.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Technologies and frameworks I use to bring innovative ideas to
              life
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 to-purple-500 mx-auto mb-6"></div>
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Innovative AI and ML projects showcasing my expertise in
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10 }}
                className={`group bg-gray-800/50 rounded-xl overflow-hidden border backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300 ${
                  project.featured
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-gray-300 text-lg">
              I am always eager to learn and grow, constantly seeking new
      ...
      <section id="contact" className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 to-purple-500 mx-auto mb-6"></div>
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Ready to collaborate on innovative projects? Feel free to reach
              out!
            </p>
          </motion.div>
